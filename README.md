...
- `autoreview` is not included here. Install the canonical skill from `https://github.com/openclaw/agent-skills/tree/main/skills/autoreview`.

## License

MIT, copyright Jesse Bounds.
